...
- [`skills/referral-management/SKILL.md`](skills/referral-management/SKILL.md): interview-driven referral catalog CRUD, inbox/MCP referral import planning, link-level `catalogRef` adoption, fork-local overlay decisions, and upstream-PR hygiene that keeps `data/policy/referral-catalog.local.json` out of shared diffs.
