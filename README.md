...
If you use Medium rich links and want the optional public follower metric cached locally, run:
...
- `bun run public:rich:sync` - refresh public browser-derived Medium profile metrics into `data/cache/rich-public-cache.json` (non-auth, operator-invoked).
