...
import { phaseChecklist, type TaskStatus } from "@/lib/phase-checklist";
    ...
    <PageShell>
      ...
      <section class="mt-6 grid gap-4">
        <For each={phaseChecklist}>
          {(phase) => (
            <Card class="border-white/20 bg-white/95 text-ink">
              <h2 class="font-display text-2xl font-bold">{phase.title}</h2>
              <p class="mt-1 text-sm text-slate-600">{phase.summary}</p>
