...
| Medium | `medium-auth-browser` | Stable public RSS/feed endpoint provides title, description, and image | `public_augmented` | Moved into built-in public augmentation + committed public cache |
