...
| `rumble-public-profile` | `public_augmented` | `html` | profile URL -> public `about` page | authored bio + follower count + avatar/banner separation for Rumble profiles | 410/not-found placeholder detection on public profile pages | `public_rich_metadata`, public cache |
