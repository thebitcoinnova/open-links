...
updated: 2026-03-10T02:35:00Z
---

## Current Test

number: 1
name: Profile Header Analytics Entry
expected: |
  On the main links page, the profile header should show a new analytics button immediately to the left of the existing Share button. Clicking it should switch the page into the all-platform follower analytics view instead of leaving you on the normal links list.
